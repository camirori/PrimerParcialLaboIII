...
function cargarTabla(){
    get_httpRequest('http://localhost:3000/materias',function(json){
        armarGrilla(json);
...
function setShowOnDblClick(tagElementosClick, idElementoMostrado){
        ...
        for(var elemClick of arrElemClick){
            elemClick.addEventListener("dblclick", function(){
                if(elemMostrado.style.display!="none")
                    ...
                    jsonToForm(tableRowToJson(this.parentElement), idElementoMostrado); 
                }
